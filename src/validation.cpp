...
int64_t GetProofOfWorkReward(unsigned int nHeight) {
   ...
   if (nHeight == 1) { return 6000000 * COIN; } // Premine
		...
		else if (nHeight > 3153600 && nHeight <= 3679200) {return  5.4 * COIN;}
        else if (nHeight > 3679200 && nHeight <= 4204800) {return  4.4 * COIN;}
	    else if (nHeight > 4204800 && nHeight <= 4730400) {return  3.5 * COIN;}
		else if (nHeight > 4730400 && nHeight <= 5256000) {return  2.8 * COIN;}
		else if (nHeight > 5256000 && nHeight <= 5781600) {return  2.3 * COIN;}
		else if (nHeight > 5781600 && nHeight <= 6307200) {return  1.84 * COIN;}
   		else if (nHeight > 6307200 && nHeight <= 6832800) {return  1.48 * COIN;}
        else if (nHeight > 6832800 && nHeight <= 7358400) {return  1.20 * COIN;}
        else if (nHeight > 7358400 && nHeight <= 7884000) {return  0.962 * COIN;}
        else if (nHeight > 7884000 && nHeight <= 8409600) {return  0.775 * COIN;}
        else if (nHeight > 8409600 && nHeight <= 8935200) {return  0.624 * COIN;}
        else if (nHeight > 8935200 && nHeight <= 9460800) {return  0.502 * COIN;}
        else if (nHeight > 9460800 && nHeight <= 9986400) {return  0.404 * COIN;}
        else if (nHeight > 9986400 && nHeight <= 10512000) {return  0.326 * COIN;}
        else if (nHeight > 10512000 && nHeight <= 11037600) {return  0.262 * COIN;}
        else if (nHeight > 11037600 && nHeight <= 11563200) {return  0.211 * COIN;}
        else if (nHeight > 11563200 && nHeight <= 12088800) {return  0.170 * COIN;}
        else if (nHeight > 12088800 && nHeight <= 12614400) {return  0.137 * COIN;}
        else if (nHeight > 12614400 && nHeight <= 13140000) {return  0.110 * COIN;}
        else if (nHeight > 13140000 && nHeight <= 13665600) {return  0.089 * COIN;}
        else if (nHeight > 13665600 && nHeight <= 14191200) {return  0.0714 * COIN;}
        else if (nHeight > 14191200 && nHeight <= 14716800) {return  0.0575 * COIN;}
        else if (nHeight > 14716800 && nHeight <= 15242400) {return  0.0463 * COIN;}
        else if (nHeight > 15242400 && nHeight <= 15768000) {return  0.0373 * COIN;}
        else if (nHeight > 15768000 && nHeight <= 16293600) {return  0.0300 * COIN;}
        else {return  0.0242 * COIN;}
